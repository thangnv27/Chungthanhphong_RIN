...
if (!defined('THEME_NAME'))
    define('THEME_NAME', "CTP Bridal");
if (!defined('SHORT_NAME'))
    define('SHORT_NAME', "bridal");
...
$options = array(
    'general' => array(
        ...
        array("name" => "Logo Footer",
            ...
            "type" => "text",
            "btn" => true),
		array("name" => "Logo Preload",
            "desc" => "Size: 102x102 px",
            "id" => "logo_preload",
            "std" => "",
            "type" => "text",
            "btn" => true),
    ...
    'theme-options' => array(
        ...
        array("name" => "Phân trang sản phẩm",
            "desc" => "Số lượng sản phẩm hiển thị trên 1 trang. Ví dụ: 15",
        ...
        array("name" => "Thanh toán thành công",
            ...
            "id" => SHORT_NAME . "_pageCheckoutComplete",
            "std" => '',
            "type" => "select",
            "options" => $page_list),
...
//            "type" => "text"),
    ...
    'home-options' => array(
        ...
        array("name" => "Image 4",
            "desc" => "",
            "id" => SHORT_NAME . "_home_image4",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "Link 4",
            "desc" => "",
            "id" => SHORT_NAME . "_home_link4",
            "std" => '',
            "type" => "text"),
        array("name" => "Text 4",
            "desc" => "",
            "id" => SHORT_NAME . "_home_text4",
            "std" => '',
            "type" => "text"),
        array("name" => "Image 5",
            "desc" => "",
            "id" => SHORT_NAME . "_home_image5",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "Link 5",
            "desc" => "",
            "id" => SHORT_NAME . "_home_link5",
            "std" => '',
            "type" => "text"),
        array("name" => "Text 5",
            "desc" => "",
            "id" => SHORT_NAME . "_home_text5",
            "std" => '',
            "type" => "text"),
        array("name" => "Image 6",
            "desc" => "",
            "id" => SHORT_NAME . "_home_image6",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "Link 6",
            "desc" => "",
            "id" => SHORT_NAME . "_home_link6",
            "std" => '',
            "type" => "text"),
        array("name" => "Text 6",
            "desc" => "",
            "id" => SHORT_NAME . "_home_text6",
            "std" => '',
            "type" => "text"),
        array("name" => "Image 7",
            "desc" => "",
            "id" => SHORT_NAME . "_home_image7",
            "std" => "",
            "type" => "text",
            "btn" => true),
        array("name" => "Link 7",
            "desc" => "",
            "id" => SHORT_NAME . "_home_link7",
            "std" => '',
            "type" => "text"),
        array("name" => "Text 7",
            "desc" => "",
            "id" => SHORT_NAME . "_home_text7",
            "std" => '',
            "type" => "text"),
        array("type" => "close"),
        array("type" => "submit"),
