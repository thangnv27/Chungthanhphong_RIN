...
var AjaxCart = {
    addToCart:function(id, thumb, title, price, quantity, redirect_url){
        var valid = true;
        if($(".color-list").find('img.active').length == 0){
            valid = false;
            jQuery(".color-error").text("Please select a color!");
        } else {
            jQuery(".color-error").text("");
        }
        if($(".size-list").find('span.active').length == 0){
            valid = false;
        ...
        if(valid){
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    size: jQuery(".size-selected").attr('data-text'),
                    locale: lang
                },
...
jQuery(document).ready(function($){
    ...
    $(".cartInfo .quantity .qtyval").change(function (){
        var val = $(this).val();
    ...
    $(".cartInfo .quantity .plus").click(function (){
    ...
    $(".cartInfo .quantity .minus").click(function (){
